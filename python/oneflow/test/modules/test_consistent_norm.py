...
def _test_one_dim_norm_with_random_data(test_case, placement, sbp):
    input = random_pytorch_tensor(ndim=4,dim0=8,dim1=8).to_consistent(
...
def _test_tuple_dim_norm_with_random_data(test_case, placement, sbp):
        input = random_pytorch_tensor(ndim=2,dim0=8,dim1=8).to_consistent(
        placement=placement, sbp=sbp
        )   
...
# test_tuple_dim_norm_with_random_data : 单卡两卡都有问题